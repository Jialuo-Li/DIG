...
for FRAMES in "${FRAMES_LIST[@]}"; do
    ...
    BASE_ARGS="pretrained=${MODEL_NAME},max_pixels=100352,min_pixels=25088,max_num_frames=${FRAMES},attn_implementation=flash_attention_2,interleave_visuals=False"
